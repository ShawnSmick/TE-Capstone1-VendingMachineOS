...
public class VendingMachine {
	...
	public boolean FeedMoney(BigDecimal amount) {
		...
		//Check if the bigdecimal is a whole currency amount
		if(amount.compareTo(new BigDecimal(1))==0||amount.compareTo(new BigDecimal(5))==0||
				amount.compareTo(new BigDecimal(10))==0||amount.compareTo(new BigDecimal(20))==0) {
